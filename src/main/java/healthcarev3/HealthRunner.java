...
public class HealthRunner {
    ...
    public static void main(String[] args) {
        ...
        DoctorService doctorService = new DoctorService((DoctorRepository) doctorRepository);
        PatientService patientService = new PatientService((PatientRepository) patientRepository);
        AppointmentService appointmentService = new AppointmentService((AppointmentRepository) appointmentRepository);
        OfficeService officeService = new OfficeService((OfficeRepository) officeRepository);
